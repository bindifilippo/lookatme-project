              ...
              <div className="w-full min-h-full p-12">
                ...
                <div className="grid grid-cols-1 gap-24 lg:grid-cols-2 lg:items-start">
                  ...
                  <aside className="space-y-10">
                    <section> 
                      <strong><p className="m-12 mb-0 text-2xl ">I musei di Torino che abbiamo visitato:</p></strong>
                      <p className="ml-12 mt-6 mb-12 text-xl ">Museo Nazionale del Risorgimento Italiano, <br />  Musei Reali, <br /> Villa della Regina</p>
                    </section>
                    <hr></hr>
                    <section> 
                      <strong><p className="m-12 mb-0  text-2xl ">Le opere che abbiamo raccontato:</p></strong>
                      <p className="ml-12 mt-6 mb-6 text-xl ">Abito appartenuto a Maria Clotilde o a Maria Pia di Savoia; Berlina-coupé cosiddetta diplomatica di Cavour; Giuseppina Bolognara; Camera dei Deputati del Parlamento Subalpino (1848-1861) e del Regno d'Italia (1861-1865), Museo Nazionale del Risorgimento Italiano Minerva e Venere, Musei Reali Naiade, Villa della Regina </p>
                      <p className="ml-12 mr-12 text-lg">Le immagini sono pubblicate su gentile concessione del Ministero della cultura, Residenze Reali Sabaude - Direzione regionale Musei Nazionali Piemonte,l Museo Nazionale del Risorgimento Italiano di Torino</p>
                    </section>
                    <hr></hr>
                    <section> 
                      <strong><p className="m-12 mb-0  text-2xl ">Le persone che hanno interpretato le opere:</p></strong>
                      <p className="ml-12 mt-6 mb-12 text-xl "> Tahereh Ahmadzadeh, Mohammad Ali Ahmadi, Elva Taipe Alanya, Chiara Billi CusimanoHodda Bourki, Jennifer Brown, Erica Carnevale, Souad Daoudi, Astou Diagne, Favour Ekhosun, Mohammad-Samad Jafari, Madeleine Kossia Koliame, Maria Rosa Liay, Yazuri Martel Ychpas, Sole Miseo, Roxana Olariu, Shobini Ratnasinghan, Luftullah Sarwari, Milagros Taipe</p>
                    </section>
                    <hr></hr>
                    <section> 
                      <p className="ml-12 mt-6 text-xl ">Curatrice del progetto: Lorena Tadorni</p>
                      <p className="ml-12 mt-6 text-xl ">Guida musei: Nemi COGNOME</p>
                      <p className="ml-12 mt-6 text-xl ">Web designer: Filippo Bindi </p>
                    </section>
                  </aside>
                </div>
                <hr></hr>
