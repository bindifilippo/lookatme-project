            ...
            <X className="w-10 h-10 text-foreground/70" />
              ...
              <div className="w-full min-h-full p-12">
                ...
                <div className="grid grid-cols-1 gap-28 lg:grid-cols-[2fr_1fr] lg:items-start">
                  <article>
                    <strong> <p className="mt-12 text-4xl">Il senso del progetto</p> </strong>
                    <p className="mt-6 text-2xl"> <strong>Look at Me è un invito e una dichiarazione.</strong> È l’atto di fermarsi davanti a un’opera del nostro patrimonio culturale e guardarla davvero. Ma è anche il coraggio di dire: “guardami”, mentre la osservo, perché dentro quello sguardo c’è la mia storia.</p>
                    ...
                    <p className="mt-6 text-2xl "> Attraverso una rilettura del patrimonio culturale in prospettiva di genere, donne con background migratorio hanno attraversato musei, immagini, simboli e narrazioni sedimentate nel tempo. Le hanno interrogate. Le hanno ribaltate. Le hanno abitate. Ogni opera è diventata uno specchio, una soglia, una possibilità di racconto. </p> 
                    ...
                    <p className="mt-6 mb-12 text-2xl "><strong>Guardare un’opera, qui, significa anche lasciarsi guardare. E riconoscere che dentro ogni sguardo c’è un mondo che merita di essere visto.</strong></p>
                  </article>
                  {/* COLONNA 2: sezioni */}
                  <aside className="space-y-10">
                   ...
                   <hr className="my-12 border-t border-black/20" />
                    ...
                    <hr className="my-12 border-t border-black/20" />
                    <section> 
                      <p className="mt-6 text-xl ">Curatrice del progetto: Lorena Tadorni</p>
                      <p className="mt-6 text-xl ">Guida musei: Nemi COGNOME</p>
                      <p className="mt-6 text-xl ">Web designer: Filippo Bindi </p>
                    </section>
                  </aside>
                </div>
                <hr className="my-12 border-t border-black/20" />
