...
export const works: Work[] = [
  {
    ...
    museum: "",
    description: "Il dipinto fu acquistato a Parigi nel 1920 da Riccardo Gualino - imprenditore, mecenate e collezionista - e donato alla Galleria Sabauda nel 1930. \n L’opera fu realizzata nella bottega fiorentina di Sandro Botticelli, probabilmente come opera autonoma ispirata alla Nascita di Venere degli Uffizi, con ripensamenti visibili nelle pose di mani, piedi e arti, come evidenziato da indagini diagnostiche del 2019. \n \n Secondo la versione di Esiodo, Venere nasce dalla spuma marina, dopo che Crono evira Urano gettandone i genitali nel mare. Dea romana dell’amore (Afrodite per i greci) e simbolo di armonia e fecondità, emerge già adulta su una conchiglia portata da Zefiro.",
    image: artwork1,
    xPercent: 70,
    yPercent: 25,
    widthPercent: 11,
  ...
  },
  {
    ...
    storie:[
      {
      id:"storia1",
      paragrafo:"Minerva usa l’elmo maschile come trofeo.\n Mi colpisce la figura viscida sopra il copricapo e l’uso dei serpenti come ornamento. \n L’uomo rappresentato sembra il tipico patriarca siciliano che sovrasta la donna, a cui non resta che lottare per affermare il proprio ruolo ", 
  ...
  },
  {
    ...
    description: "L'abito è associato alle principesse sabaude Maria Clotilde (1843-1911) e Maria Pia (1847-1911). Figlie di Vittorio Emanuele II, incarnavano l'immagine della monarchia sabauda post-unitaria e rappresentavano la nuova generazione dei Savoia dopo l'Unità d'Italia del 1861. \n Il vestito riflette la moda elegante risorgimentale e post-unitaria di fine Ottocento, con ombrellino e ventaglio come accessori funzionali e decorativi per moderne dame di corte.",
    image: artwork6,
    xPercent: 13,
    yPercent: 30,
    widthPercent: 8,
